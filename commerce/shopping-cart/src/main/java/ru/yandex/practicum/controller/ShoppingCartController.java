...
public class ShoppingCartController implements ShoppingCartOperations {
    ...
    public ShoppingCartDto getShoppingCart(String username) {
        log.info("GET /api/v1/shopping-cart - текущая корзина пользователя {}", username);
    ...
    public ShoppingCartDto addProductToShoppingCart(String username, Map<UUID, Integer> products) {
        log.info("PUT /api/v1/shopping-cart - Добавляем товар в корзину пользователя {}", username);
    ...
    public void deactivateCurrentShoppingCart(String username) {
        log.info("DELETE /api/v1/shopping-cart - Деактивация корзины для пользователя {}", username);
    ...
    public ShoppingCartDto removeFromShoppingCart(String username, List<UUID> products) {
        log.info("POST /api/v1/shopping-cart/remove - Изменяем состав товаров в корзине пользователя {}", username);
    ...
    public ShoppingCartDto changeProductQuantity(String username, ChangeProductQuantityRequest request) {
        log.info("POST /api/v1/shopping-cart/change-quantity - Изменяем количество товаров в корзине пользователя {}", username);
